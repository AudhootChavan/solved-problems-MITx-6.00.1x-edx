...
#print(isValidWord('', getFrequencyDict(''), wordList))
...
def playHand(hand, wordList, n):
   ...
   """
    ...
    while True:
        ...
        if isValidWord(user, hand, wordList) == True:
            total = total + getWordScore(user,n)
            print('"' + user + '"' + ' earned ' + str(getWordScore(user,n )) + ' points. Total: ' + str(total)  + ' points')
